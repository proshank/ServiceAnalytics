...
Due to these dependencies, you must perform some one-time setup tasks before building and running the application.

> One-Time Setup Tasks

 1. Download and install JDK version 1.8, if necessary.
 2. Download and install Maven version 3.1.1 or newer if necessary. I used Maven version Maven version 3.3.9
...
1. Compile application using maven
